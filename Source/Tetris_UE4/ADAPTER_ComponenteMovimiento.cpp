...
UADAPTER_ComponenteMovimiento::UADAPTER_ComponenteMovimiento()
{
...
void UADAPTER_ComponenteMovimiento::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UADAPTER_ComponenteMovimiento::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
